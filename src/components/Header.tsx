...
const Header = () => {
  return (
    ...
    <div className="flex justify-between  ">
      ...
      <Image src="/assets/logo.png" width={180} className='block h-9 sm:w-auto w-[180px]' height={10} alt="Logo" />
      <button className='h-7 flex bg-black text-slate-50 items-center py-5 px-6 gap-2 border border-solid border-black shadow-[-7px_7px_0px_#cac7c7]'>Get Started</button>
    </div>
    <div className="text-center my-8">
      ...
      <form action="" className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto border border-black shadow-[-7px_7px_0px_#000000]'>
